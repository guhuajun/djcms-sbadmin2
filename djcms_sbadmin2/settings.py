...
"""
Django settings for djcms_sbadmin2 project.
...
SECRET_KEY = 'i3oj(n05#)9n0ai19kjz-y2ay6_84db-l&w2cq2wp46n(+%m!_'
...
ROOT_URLCONF = 'djcms_sbadmin2.urls'


WSGI_APPLICATION = 'djcms_sbadmin2.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'djcms_sbadmin2', 'static'),
)
SITE_ID = 1
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'djcms_sbadmin2', 'templates'), ],
        'OPTIONS': {
            'context_processors': [
